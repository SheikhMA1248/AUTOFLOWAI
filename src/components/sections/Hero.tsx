    ...
    <section className="relative min-h-screen flex items-center pt-20 pb-16 overflow-hidden bg-cream">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div 
            ref={contentRef} 
            className="order-2 lg:order-1 animate-on-scroll slide-in-left"
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
              ...
              <a 
                href="#services" 
                className="flex items-center text-gray-700 hover:text-blue-500 transition-colors font-medium w-full sm:w-auto justify-center"
              >
          ...
          <div 
            ref={imageRef}
            className="order-1 lg:order-2 animate-on-scroll slide-in-right"
          >
